...
<div class="puso">
    <form action="databarangTA.php" method='post'>
    <span>Nama Barang : </span> <input type="text" name='namabarang' class='form-control'> <br>
    <span>Harga Barang : </span> <input type="text" name='hargabarang' class='form-control'> <br>
    <span>Harga Jual : </span> <input type="text" name='hargajual' class='form-control'> <br>
    <!-- <span>Jumlah : </span> <input type="text"  name='jumlah' class='form-control'> <br> -->
    <span>pilih suply : </span>   
									<select name="suply" class="form-control" required="required" autocomplete='off'>
										<option value="">- Pilih -</option>
										<?php
											$s = mysqli_query($connect,"SELECT kode_suply FROM  tbl_suply ORDER BY nama_suply ASC");
											while($rs=mysqli_fetch_array($s)){
										?>
										<option value="<?php echo $rs['kode_suply']; ?>"><?php echo $rs['kode_suply']; ?></option>
                      <?php } ?>
