...
<div class="puso">
    <form action="suplyTA.php" method='post'>
    <span>Kode Suply : </span> <input type="text" name='ks1' class='form-control'> <br>
    <span>Nama Suply : </span> <input type="text" name='ns' class='form-control'> <br>
    <span>Kontak Suply : </span> <input type="text" name='ks2' class='form-control'> <br>
    <span>Alamat Suply: </span> <input type="text"  name='as' class='form-control'> <br>
    <span>Cv Suply: </span> <input type="text"  name='cs' class='form-control'> <br>
